...
the old blog works fine, but from the perspective of a developer, it is quite a hassle. i have to manually update the index everytime i publish a new post. additionally, i did not use any of the Jekyll features like tags, categories, and the whole thing did utilise the blogging features of Jekyll.
