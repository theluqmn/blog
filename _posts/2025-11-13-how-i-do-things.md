...
The risk management process is [Dr David Hillson's](https://risk-doctor.com) simplification of techniques used in risk management. Risk is defined as **uncertainty that matters** - it also includes opportunities. In risk management, you mitigate risks, and exploit opportunties. It consists of only six steps:
